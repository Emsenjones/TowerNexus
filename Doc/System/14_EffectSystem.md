...
Cannon primary, additional, and bounced Shells own independent integer direct-damage values. Explosive Shell damage remains independently authored by its EffectDefinition and is not derived from any Shell's direct damage.
