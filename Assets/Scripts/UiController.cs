...
public class UiController : MonoBehaviour
{
    ...
    void GenerateMonsterHealthBar(MonsterBehaviour monster)
    {
        HealthBarBehaviour healthBar = DungeonManager.Instance.RecyclePoolController.GenerateOneObject(healthBarPrefab, healthBarContainer).GetComponent<HealthBarBehaviour>();
    ...
    void OnEnable()
    {
       MonsterBehaviour.OnInitialize += GenerateMonsterHealthBar;
    }
    void OnDisable()
    {
        MonsterBehaviour.OnInitialize -= GenerateMonsterHealthBar;
